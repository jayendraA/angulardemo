...
//for each loop
    ...
    // console.log(JSON.stringify(playStore))
     ...
     /* ---------------------Promise--------------------------------------------
        ...
        console.log(wifeTicketBringing"Person2: shows Ticket");
        const wifeTiwifeTicketBringingcketBringing=new Promise((resolve,reject)=>{
          setTimeoutwifeTicketBringing(()=>{
            resolve(wifeTicketBringing'Ticket');
          },3000);wifeTicketBringing
        wifeTicketBringing
        });wifeTicketBringing
